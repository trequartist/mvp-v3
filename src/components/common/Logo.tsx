...
const Logo: React.FC<LogoProps> = ({ className = "w-8 h-8" }) => (
  <div className={`relative ${className}`}>
    ...
    <div className="absolute inset-0 bg-gradient-to-br from-blue-500 via-blue-600 to-purple-600 rounded-full opacity-90" />
    ...
    {/* Pulsing rings */}
    <motion.div
      className="absolute -inset-1 rounded-full bg-gradient-to-br from-blue-400 to-purple-400"
      animate={{ 
        scale: [1, 1.2, 1],
        opacity: [0.15, 0, 0.15]
      }}
    ...
    <motion.div
      className="absolute -inset-2 rounded-full bg-gradient-to-br from-blue-400 to-purple-400"
      animate={{ 
        scale: [1, 1.3, 1],
        opacity: [0.1, 0, 0.1]
      }}
